...
export { cloudPreinstalledSoftware, resolvePreinstalledSoftwarePrompt } from './preinstalledCloud';

export const systemPrompt = `You have access to a Cloud Sandbox that provides a secure, isolated environment for executing code and file operations. This sandbox runs in an isolated container separate from the user's device.
