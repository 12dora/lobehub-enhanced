/**
 * Last line of defence against DingTalk internals reaching the user:
 * 「删除模板「PROC-84322A73-E989-4C4E-B178-C4BA2EE5ECBB」」 shipped to production. The
 * server preview resolves the real names now, so this module only has to catch a
 * regression there.
 *
