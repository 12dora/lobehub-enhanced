export default {
  ...
  'nav.system': 'System',
  'nav.dingtalkApprovalRules': 'Auto-approval rules',
  ...
  'users.list.searchPlaceholder': 'Search name, pinyin, email or username',
  ...
  'audit.autoReason.dingtalkApprovalRuleDisable': 'Auto-approval rule disabled from admin console',
  ...
  'system.capabilities.hint.sandbox':
    'Check the sandbox image and pull policy in Admin → General settings → Infrastructure.',
  'system.capabilities.hint.system_agent_models':
    'Check the system assistant models in Admin → Service models.',
  ...
  'system.dependencies.checkedAt': 'Checked {{time}}',
  'system.dependencies.neverChecked': 'Not checked yet',
  'system.documentRender.failed24h': 'Failed in the last 24 hours: {{count}}',
  ...
  'system.recentEvents.level.warning': 'Alert',
  'system.recentEvents.showAll': 'Show all ({{count}})',
  'system.recentEvents.showLess': 'Show fewer',
  'system.runtimeErrors.empty': 'No runtime errors in the last 24 hours.',
  ...
  'system.subsystems.dingtalk_api': 'DingTalk API',
  'system.subsystems.dingtalk_stream': 'DingTalk Stream',
  'system.subsystems.document_export': 'File export',
  'system.subsystems.document_render': 'Document render',
  'system.subsystems.local_system': 'Local system tools',
  'system.subsystems.market': 'Skill market',
  'system.subsystems.memory': 'Memory',
  'system.subsystems.reminder_worker': 'Reminders',
  'system.subsystems.sandbox': 'Sandbox',
  'system.subsystems.system_agent': 'System assistant',
  'system.subsystems.task_scheduler': 'Scheduled tasks',
  'system.workers.approval_worker': 'DingTalk auto-approval',
  'system.workers.directory_sync': 'DingTalk directory sync',
  'system.workers.dingtalk_stream': 'DingTalk Stream',
  'system.workers.document_render': 'Document render',
  'system.workers.notStarted': 'Not started',
  'system.workers.reminder': 'Reminders',
  'system.workers.stale': 'No recent tick',
  'system.workers.task_scheduler': 'Scheduled tasks',
  ...
  'system.interval.hours': 'Every {{count}} h',
  'system.interval.minutes': 'Every {{count}} min',
  'system.interval.seconds': 'Every {{count}} s',
  'system.relative.days': '{{count}} d ago',
  'system.relative.hours': '{{count}} h ago',
  'system.relative.justNow': 'just now',
  'system.relative.minutes': '{{count}} min ago',
  'system.relative.seconds': '{{count}} s ago',
  'system.summary.allHealthy': 'All systems healthy',
  'system.summary.more': '+{{count}} more',
  'system.summary.problems': 'Problems found: {{count}}',
  'system.summary.runtimeLabel': '{{name}} runtime errors',
  'system.summary.separator': ', ',
  ...
  'systemGeneral.imConnectors.test.robotName': 'Robot {{name}}',
  'systemGeneral.imConnectors.test.errors.auth_failed':
    'Authentication failed. Check the Client ID and Client Secret.',
  'systemGeneral.imConnectors.test.errors.network':
    'Could not reach DingTalk. Check the network or the proxy.',
  ...
  'systemGeneral.imConnectors.workspace.fields.tier': 'Automatic approval tier',
  'systemGeneral.imConnectors.workspace.hints.approval':
    "Read pending approvals, submit applications, and approve or refuse on the member's behalf.",
  'systemGeneral.imConnectors.workspace.hints.todo':
    "Create, update and complete the member's DingTalk to-dos.",
  'systemGeneral.imConnectors.workspace.hints.calendar':
    "Check free time, and create or adjust the member's calendar events.",
  'systemGeneral.imConnectors.workspace.tier.options.off': 'Off',
  'systemGeneral.imConnectors.workspace.tier.options.strict': 'Strict',
  'systemGeneral.imConnectors.workspace.tier.options.moderate': 'Moderate',
  'systemGeneral.imConnectors.workspace.tier.options.relaxed': 'Relaxed',
  ...
  'systemGeneral.imConnectors.workspace.probe.reason.unreachable': 'Could not connect',
  'systemGeneral.imConnectors.workspace.probe.reason.unknown': 'Could not check',
  'systemGeneral.imConnectors.workspace.probe.failed': 'Could not check permissions. Try again.',
  'systemGeneral.imConnectors.workspace.tierConfirm.title': 'Change the automatic approval tier?',
  ...
  'systemGeneral.imConnectors.bindings.conflictIdentityEmail':
    "This DingTalk user matches {{name}}'s sign-in identity.",
  ...
  'systemGeneral.imConnectors.bindings.rebindConsequence':
  ...
  'systemGeneral.imConnectors.bindings.total': '{{total}} in total.',
  'systemGeneral.imConnectors.bindings.truncated':
    'Showing the {{shown}} most recent of {{total}}. Use search to narrow it down.',
  ...
  // 企业查询 — QCC / Tianyancha credentials, category scope and the per-user daily cap.
  ...
  'systemGeneral.enterpriseLookup.fields.status': 'Status',
  'systemGeneral.enterpriseLookup.fields.enabled': 'Enabled',
  'systemGeneral.enterpriseLookup.fields.apiKey': 'API key',
  'systemGeneral.enterpriseLookup.fields.categories': 'Lookup categories',
  'systemGeneral.enterpriseLookup.fields.defaultProvider': 'Default provider',
  'systemGeneral.enterpriseLookup.fields.fallback': 'Switch provider on failure',
  'systemGeneral.enterpriseLookup.fields.dailyLimit': 'Daily limit per user',
  'systemGeneral.enterpriseLookup.fields.updatedAt': 'Last updated',
  'systemGeneral.enterpriseLookup.values.disabled': 'Off',
  'systemGeneral.enterpriseLookup.values.enabled': 'On',
  'systemGeneral.enterpriseLookup.values.enabledNoKey': 'On · no credential',
  'systemGeneral.enterpriseLookup.values.enabledWithKey': 'On · credential {{fingerprint}}',
  'systemGeneral.enterpriseLookup.values.unlimited': 'Unlimited',
  'systemGeneral.enterpriseLookup.values.perDay': '{{count}} per day',
  'systemGeneral.enterpriseLookup.noProviderEnabled': 'Enable at least one provider first.',
  'systemGeneral.enterpriseLookup.hints.qccEnabled': 'Lets assistants query company data from QCC.',
  'systemGeneral.enterpriseLookup.hints.tianyanchaEnabled':
    'Lets assistants query company data from Tianyancha.',
  'systemGeneral.enterpriseLookup.hints.apiKey': 'Stored encrypted and never displayed again.',
  'systemGeneral.enterpriseLookup.hints.categories':
    'Only the categories selected here are offered to assistants.',
  'systemGeneral.enterpriseLookup.hints.verifiedCategories':
    'Corporate history requires enterprise identity verification with QCC first.',
  'systemGeneral.enterpriseLookup.hints.defaultProvider':
    'Used whenever a lookup does not name a provider.',
  'systemGeneral.enterpriseLookup.hints.dailyLimit': '0 means unlimited. Maximum {{max}}.',
  'systemGeneral.enterpriseLookup.hints.fallback':
    'Falls back to the other enabled provider while the current one is unavailable.',
  'systemGeneral.enterpriseLookup.test.success': 'Connected',
  'systemGeneral.enterpriseLookup.test.toolCount': '{{count}} tools available',
  'systemGeneral.enterpriseLookup.test.reason.notConfigured': 'Not configured',
  'systemGeneral.enterpriseLookup.test.reason.unauthorized': 'Invalid credential',
  'systemGeneral.enterpriseLookup.test.reason.unreachable': 'Could not connect',
  'systemGeneral.enterpriseLookup.test.reason.timeout': 'Connection timed out',
  'systemGeneral.enterpriseLookup.test.reason.quotaExceeded': 'Quota used up',
  'systemGeneral.enterpriseLookup.categories.company': 'Company profile',
  'systemGeneral.enterpriseLookup.categories.risk': 'Risk',
  'systemGeneral.enterpriseLookup.categories.ipr': 'Intellectual property',
  'systemGeneral.enterpriseLookup.categories.operation': 'Operations',
  'systemGeneral.enterpriseLookup.categories.executive': 'Key personnel',
  'systemGeneral.enterpriseLookup.categories.regulation': 'Regulatory actions',
  'systemGeneral.enterpriseLookup.categories.case': 'Legal cases',
  'systemGeneral.enterpriseLookup.categories.tender': 'Tenders',
  'systemGeneral.enterpriseLookup.categories.history': 'Corporate history',
  'systemGeneral.enterpriseLookup.categories.document': 'Company documents',
  'systemGeneral.enterpriseLookup.errors.secretRequired':
    'Enter an API key before enabling this provider.',
  'systemGeneral.enterpriseLookup.errors.secretTooLong':
    'The API key may not exceed 512 characters.',
  'systemGeneral.enterpriseLookup.errors.categoryRequired': 'Select at least one category.',
  'systemGeneral.enterpriseLookup.errors.defaultProvider':
    'The default provider must be one that is enabled.',
  'systemGeneral.enterpriseLookup.errors.dailyLimit': 'Enter a whole number between 0 and 10000.',
  ...
  'audit.logs.action.dingtalk.approval.agree': 'Agree DingTalk approval',
  'audit.logs.action.dingtalk.approval.append': 'Add DingTalk approver',
  'audit.logs.action.dingtalk.approval.comment': 'Comment on DingTalk approval',
  'audit.logs.action.dingtalk.approval.create': 'Submit DingTalk approval',
  'audit.logs.action.dingtalk.approval.delete_template': 'Delete DingTalk approval template',
  'audit.logs.action.dingtalk.approval.redirect': 'Transfer DingTalk approval',
  'audit.logs.action.dingtalk.approval.refuse': 'Refuse DingTalk approval',
  'audit.logs.action.dingtalk.approval.revert': 'Return DingTalk approval',
  'audit.logs.action.dingtalk.approval.rule.create': 'Create DingTalk approval rule',
  'audit.logs.action.dingtalk.approval.rule.delete': 'Delete DingTalk approval rule',
  'audit.logs.action.dingtalk.approval.rule.update': 'Update DingTalk approval rule',
  'audit.logs.action.dingtalk.approval.rule_executed': 'Run DingTalk approval rule',
  'audit.logs.action.dingtalk.approval.save_template': 'Save DingTalk approval template',
  'audit.logs.action.dingtalk.approval.terminate': 'Withdraw DingTalk approval',
  'audit.logs.action.dingtalk.calendar.create': 'Create DingTalk calendar event',
  ...
  'audit.logs.action.dingtalk.todo.update': 'Update DingTalk to-do',
  'audit.logs.action.enterprise_lookup.query': 'Enterprise lookup query',
  ...
  'audit.logs.action.system.dingtalk.approval_rule.disable': 'Disable DingTalk approval rule',
  ...
  'audit.logs.action.system.infra.enterprise_lookup.update': 'Update enterprise lookup',
  ...
  'audit.logs.targetType.im_connector': 'IM connector',
  ...
  'audit.logs.targetId.global': 'Global',
  ...
  'audit.logs.detail.close': 'Close panel',
  ...
  'audit.conversations.topic.bodyToggleLabel': 'Load content',
  ...
  'audit.live.page.desc': 'Watch a user’s chats with AI in real time. Body access is audited.',
  ...
  'audit.chat.messageError': 'This reply failed',
  'audit.chat.redacted': 'Redacted by the server',
  ...
  'contentModeration.records.filters.user': 'Search name, pinyin, email or username or user ID',
  ...
  'dingtalkApprovalRules.action.agree': 'Approve',
  'dingtalkApprovalRules.action.comment': 'Comment',
  'dingtalkApprovalRules.action.redirect': 'Transfer',
  'dingtalkApprovalRules.action.redirectTo': 'Transfer to {{name}}',
  'dingtalkApprovalRules.action.refuse': 'Reject',
  'dingtalkApprovalRules.alreadyDisabled': 'This rule is already stopped.',
  'dingtalkApprovalRules.columns.action': 'Action',
  'dingtalkApprovalRules.columns.actions': 'Actions',
  'dingtalkApprovalRules.columns.condition': 'Conditions',
  'dingtalkApprovalRules.columns.expiry': 'Valid until',
  'dingtalkApprovalRules.columns.lastRun': 'Last run',
  'dingtalkApprovalRules.columns.owner': 'Owner',
  'dingtalkApprovalRules.columns.rule': 'Rule',
  'dingtalkApprovalRules.columns.status': 'Status',
  'dingtalkApprovalRules.columns.template': 'Approval template',
  'dingtalkApprovalRules.desc':
    'Users can let the assistant handle approvals automatically with their own DingTalk identity. Administrators can only force a rule to stop, never create one for someone else.',
  'dingtalkApprovalRules.disabledReason.admin': 'Disabled by administrator',
  'dingtalkApprovalRules.disabledReason.expired': 'Expired',
  'dingtalkApprovalRules.disabledReason.identityInvalid': 'DingTalk identity unavailable',
  'dingtalkApprovalRules.disabledReason.tierOff': 'Automatic approval turned off',
  'dingtalkApprovalRules.disabledReason.user': 'Disabled by owner',
  'dingtalkApprovalRules.empty': 'No automatic approval rules yet',
  'dingtalkApprovalRules.emptyFiltered': 'No rules match this search',
  'dingtalkApprovalRules.expiry.never': 'No expiry',
  'dingtalkApprovalRules.forceDisable': 'Force disable',
  'dingtalkApprovalRules.forceDisableConfirm':
    'Stop “{{rule}}” owned by {{user}}? Matching requests then go back to manual approval.',
  'dingtalkApprovalRules.forceDisableTitle': 'Force disable rule',
  'dingtalkApprovalRules.noOperatePermission': 'You do not have permission to disable rules.',
  'dingtalkApprovalRules.noReadPermission':
    'You do not have permission to view automatic approval rules.',
  'dingtalkApprovalRules.searchPlaceholder': 'Search rule, template or owner',
  'dingtalkApprovalRules.title': 'Auto-approval rules',
  'dingtalkApprovalRules.toast.forceDisableFailed': 'Could not disable the rule. Try again.',
  'dingtalkApprovalRules.toast.forceDisabled': 'Rule disabled',
  'dingtalkApprovalRules.unavailable':
    'DingTalk approval is not enabled, so there are no automatic approval rules to manage. Turn on the approval capability on the DingTalk connector in General settings.',
};
