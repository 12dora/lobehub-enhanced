export default {
  ...
  'reminderList.action.cancel': 'Cancel reminder',
  'reminderList.action.delete': 'Delete',
  'reminderList.action.fireNow': 'Send now',
  'reminderList.action.open': 'Open',
  'reminderList.channel.robot': 'Service account',
  'reminderList.channel.status.failed': 'Failed',
  'reminderList.channel.status.none': 'Not sent',
  'reminderList.channel.status.sent': 'Sent',
  'reminderList.channel.status.skipped': 'Skipped',
  'reminderList.channel.workNotice': 'Work notification',
  'reminderList.column.actions': 'Actions',
  'reminderList.column.channel': 'Channels',
  'reminderList.column.content': 'Content',
  'reminderList.column.from': 'From',
  'reminderList.column.lastFire': 'Last sent',
  'reminderList.column.nextFire': 'Next send',
  'reminderList.column.recipients': 'Recipients',
  'reminderList.column.schedule': 'Schedule',
  'reminderList.column.status': 'Status',
  'reminderList.column.time': 'Time',
  'reminderList.confirm.cancel': 'Cancel this reminder? It will not be sent again.',
  'reminderList.confirm.delete': 'Remove this reminder from your list?',
  'reminderList.confirm.dismiss': 'Cancel',
  'reminderList.confirm.fireNow': 'Send this reminder to its recipients now?',
  'reminderList.delivery.counts': 'Sent {{sent}} · Failed {{failed}} · Skipped {{skipped}}',
  'reminderList.empty.created': 'No scheduled reminders',
  'reminderList.empty.received': 'No reminders received',
  'reminderList.field.creator': 'Set by',
  'reminderList.field.from': 'From {{name}}',
  'reminderList.field.nextFire': 'Next send',
  'reminderList.field.recipients': 'Recipients',
  'reminderList.field.repeat': 'Repeat',
  'reminderList.field.sentAt': 'Sent at',
  'reminderList.loadFailed': 'Failed to load reminders',
  'reminderList.recipients.department': '{{name}} · {{count}} people',
  'reminderList.recipients.departmentOnly': '{{name}}',
  'reminderList.recipients.more': '+{{count}}',
  'reminderList.recipients.separator': ', ',
  'reminderList.recipients.user': '{{name}} · {{dept}}',
  'reminderList.recipients.userOnly': '{{name}}',
  'reminderList.repeat.daily': 'Daily at {{time}}',
  'reminderList.repeat.monthly': 'Monthly on days {{days}} at {{time}}',
  'reminderList.repeat.separator': ', ',
  'reminderList.repeat.weekly': 'Weekly on {{days}} at {{time}}',
  'reminderList.retry': 'Retry',
  'reminderList.section.created': 'Created by me',
  'reminderList.section.received': 'Received',
  'reminderList.showFinished': 'Show finished',
  'reminderList.status.canceled': 'Canceled',
  'reminderList.status.completed': 'Completed',
  'reminderList.status.expired': 'Expired',
  'reminderList.status.failed': 'Failed',
  'reminderList.status.inProgress': 'In progress',
  'reminderList.status.scheduled': 'Scheduled',
  'reminderList.status.sent': 'Sent',
  'reminderList.tab.reminders': 'Reminders',
  'reminderList.tab.tasks': 'Tasks',
  'reminderList.toast.cancelFailed': 'Failed to cancel the reminder',
  'reminderList.toast.canceled': 'Reminder canceled',
  'reminderList.toast.deleteFailed': 'Failed to delete the reminder',
  'reminderList.toast.deleted': 'Reminder deleted',
  'reminderList.toast.fireFailed': 'Failed to send the reminder',
  'reminderList.toast.fired': 'Sent {{sent}} · Failed {{failed}} · Skipped {{skipped}}',
  'reminderList.weekday.1': 'Mon',
  'reminderList.weekday.2': 'Tue',
  'reminderList.weekday.3': 'Wed',
  'reminderList.weekday.4': 'Thu',
  'reminderList.weekday.5': 'Fri',
  'reminderList.weekday.6': 'Sat',
  'reminderList.weekday.7': 'Sun',
  ...
  'taskReminder.action.cancel': 'Cancel reminder',
  'taskReminder.action.fireNow': 'Send now',
  'taskReminder.cancel.failed': 'Failed to cancel the reminder',
  'taskReminder.cancel.success': 'Reminder canceled',
  'taskReminder.clarify.candidate': '{{name}} · {{dept}}',
  'taskReminder.clarify.candidatesFor': '“{{name}}” could be:',
  'taskReminder.clarify.title': 'Some names are ambiguous — pick the right person',
  'taskReminder.clarify.unknown': 'Not found: {{names}}',
  'taskReminder.confirm.cancel': 'Cancel this reminder? It will not be sent again.',
  'taskReminder.confirm.dismiss': 'Cancel',
  'taskReminder.confirm.fireNow': 'Send this reminder to its recipients right now?',
  'taskReminder.confirm.ok': 'Confirm',
  'taskReminder.editHint':
    'To change the recipients, edit the @name·department mentions in the body — the assistant re-reads and reschedules it when you save.',
  'taskReminder.field.lastSent': 'Last sent',
  'taskReminder.field.recipients': 'Recipients',
  'taskReminder.field.schedule': 'Repeat / time',
  'taskReminder.field.until': 'End date',
  'taskReminder.fireNow.failed': 'Failed to send the reminder',
  'taskReminder.fireNow.success':
    'Sent — {{sent}} delivered, {{failed}} failed, {{skipped}} skipped',
  'taskReminder.instruction.discard': 'Discard changes',
  'taskReminder.instruction.hint':
    'Press Save — the assistant re-reads the recipients and the time.',
  'taskReminder.instruction.save': 'Save',
  'taskReminder.instruction.saveFailed': 'Failed to save the reminder',
  'taskReminder.instruction.saved': 'Saved · {{count}} recipients · {{schedule}}',
  'taskReminder.instruction.scheduleUnchanged': 'schedule unchanged',
  'taskReminder.lastSent.never': 'Not sent yet',
  'taskReminder.mention.department': '{{name}} · {{count}} people',
  'taskReminder.mention.user': '{{name}} · {{dept}}',
  'taskReminder.recipient.user': '{{name}} · {{dept}}',
  'taskReminder.recipients.empty': 'No recipients on the first line of the body',
  'taskReminder.schedule.daily': 'Daily at {{time}}',
  'taskReminder.schedule.monthly': 'Monthly on day {{days}} at {{time}}',
  'taskReminder.schedule.once': '{{date}} {{time}}, once',
  'taskReminder.schedule.separator': ', ',
  'taskReminder.schedule.weekly': 'Weekly on {{days}} at {{time}}',
  'taskReminder.status.canceled': 'Canceled',
  'taskReminder.status.completed': 'Completed',
  'taskReminder.tag': '⏰ Reminder',
  'taskReminder.title': 'Scheduled reminder',
  'taskReminder.weekday.1': 'Mon',
  'taskReminder.weekday.2': 'Tue',
  'taskReminder.weekday.3': 'Wed',
  'taskReminder.weekday.4': 'Thu',
  'taskReminder.weekday.5': 'Fri',
  'taskReminder.weekday.6': 'Sat',
  'taskReminder.weekday.7': 'Sun',
