export default {
  ...
  'taskReminder.error.contentEmpty': 'The reminder text cannot be empty',
  'taskReminder.error.scheduleInvalid':
    'Could not read the reminder time — write it explicitly, e.g. “every day at 9:00”',
  'taskReminder.error.timePast': 'That time is already past — pick a time in the future',
  'taskReminder.field.lastSent': 'Last sent',
  'taskReminder.field.nextFire': 'Next send',
  ...
  'taskReminder.mention.searchFailed': 'Directory lookup failed — try again',
  'taskReminder.mention.user': '{{name}} · {{dept}}',
  'taskReminder.nextFire.none': 'Not scheduled',
