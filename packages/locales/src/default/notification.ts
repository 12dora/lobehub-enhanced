export default {
  ...
  'task.event.task_completed': 'Task completed',
  'task.event.task_completedDesc': 'A task reached the completed state.',
  'task.event.task_run_completed': 'Run completed',
  'task.event.task_run_completedDesc': 'A task run finished successfully.',
  'task.event.task_run_failed': 'Run failed',
  'task.event.task_run_failedDesc': 'A task run failed or timed out.',
  'task.event.task_waiting_for_user': 'Waiting for you',
  'task.event.task_waiting_for_userDesc': 'A task needs your confirmation or input.',
  'task.reminder.channel.dingtalk': 'DingTalk',
  'task.reminder.channel.dingtalkCheckFailed': 'Could not load DingTalk push availability.',
  'task.reminder.channel.dingtalkChecking': 'Checking DingTalk push availability.',
  'task.reminder.channel.dingtalkDesc': 'Push to DingTalk through the enterprise robot.',
  'task.reminder.channel.dingtalkLinkedAs': 'Pushes to DingTalk account {{name}}',
  'task.reminder.channel.dingtalkRetry': 'Retry',
  'task.reminder.channel.dingtalkUnavailable': 'DingTalk push is not enabled by the administrator.',
  'task.reminder.channel.dingtalkUnlinked':
    'This account is not linked to DingTalk, so DingTalk reminders will not be delivered. Sign in with a DingTalk account or ask an administrator to bind one under IM connectors.',
  'task.reminder.channel.inbox': 'In-app notifications',
  'task.reminder.channel.inboxDesc': 'Show task reminders in the notification center.',
  'task.reminder.entry': 'Reminder settings',
  'task.reminder.noChannel': 'Enable at least one channel to receive task reminders.',
  'task.reminder.reset': 'Restore defaults',
  'task.reminder.save': 'Save',
  'task.reminder.saveFailed': 'Could not save. Try again.',
  'task.reminder.saved': 'Saved',
  'task.reminder.section.channels': 'Channels',
  'task.reminder.section.events': 'Events',
  'task.reminder.title': 'Task reminders',
