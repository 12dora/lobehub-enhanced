export default {
  ...
  'task.reminder.channel.dingtalkLink.adminImConnectors': 'Admin: IM connector settings',
  'task.reminder.channel.dingtalkLink.binding': 'Link DingTalk',
  ...
  'task.reminder.channel.dingtalkUnlinked':
    'This account is not linked to DingTalk, so DingTalk reminders will not be delivered. Sign in with a DingTalk account, send the DingTalk bot a message, or ask an administrator to bind one under IM connectors.',
