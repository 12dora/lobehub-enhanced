export default {
  ...
  'builtins.dingtalk.action.adminImConnectors': 'Admin: IM connector settings',
  'builtins.dingtalk.action.approvalRules': 'Manage my approval rules',
  'builtins.dingtalk.action.binding': 'Link DingTalk',
  'builtins.dingtalk.action.cliSettings': 'DingTalk developer console → CLI settings',
  'builtins.dingtalk.action.patConfirm': 'Confirm the permission in DingTalk',
  'builtins.dingtalk.action.personalAuthorize': 'Authorize',
  'builtins.dingtalk.action.resolve': 'Resolve',
  ...
  'builtins.lobe-enterprise-lookup.apiName.companyProfile': 'Company profile',
  'builtins.lobe-enterprise-lookup.apiName.listCapabilities': 'List capabilities',
  'builtins.lobe-enterprise-lookup.apiName.queryEnterprise': 'Query enterprise',
  'builtins.lobe-enterprise-lookup.description':
    'Look up company registration, risk, intellectual property, and related records',
  'builtins.lobe-enterprise-lookup.inspector.capabilities': 'Capabilities',
  'builtins.lobe-enterprise-lookup.render.candidates': 'Matching companies ({{count}})',
  'builtins.lobe-enterprise-lookup.render.collapse': 'Show less',
  'builtins.lobe-enterprise-lookup.render.column.field': 'Field',
  'builtins.lobe-enterprise-lookup.render.column.value': 'Value',
  'builtins.lobe-enterprise-lookup.render.empty': 'No details were returned.',
  'builtins.lobe-enterprise-lookup.render.expand': 'Show more',
  'builtins.lobe-enterprise-lookup.render.provider.qcc': 'QCC',
  'builtins.lobe-enterprise-lookup.render.provider.tianyancha': 'Tianyancha',
  'builtins.lobe-enterprise-lookup.render.result': 'Raw response',
  'builtins.lobe-enterprise-lookup.render.total': '{{count}} records in total',
  'builtins.lobe-enterprise-lookup.render.truncated': 'Truncated',
  'builtins.lobe-enterprise-lookup.title': 'Enterprise Lookup',
  ...
  'builtins.lobe-dingtalk-personal.apiName.completeTodo': 'Complete to-do',
  'builtins.lobe-dingtalk-personal.apiName.downloadMessageFile': 'Download group file',
  'builtins.lobe-dingtalk-personal.apiName.getReport': 'Get report',
  'builtins.lobe-dingtalk-personal.apiName.getReportTemplate': 'Get report template',
  'builtins.lobe-dingtalk-personal.apiName.getTodo': 'Get to-do',
  'builtins.lobe-dingtalk-personal.apiName.listGroupMessages': 'Read group messages',
  'builtins.lobe-dingtalk-personal.apiName.listMyGroups': 'List my groups',
  'builtins.lobe-dingtalk-personal.apiName.listMyTodos': 'List my to-dos',
  'builtins.lobe-dingtalk-personal.apiName.listReportTemplates': 'List report templates',
  'builtins.lobe-dingtalk-personal.apiName.listReports': 'List reports',
  'builtins.lobe-dingtalk-personal.apiName.searchGroups': 'Search groups',
  'builtins.lobe-dingtalk-personal.apiName.searchMessages': 'Search messages',
  'builtins.lobe-dingtalk-personal.apiName.submitReport': 'Submit report',
  'builtins.lobe-dingtalk-personal.apiName.updateTodo': 'Update to-do',
  'builtins.lobe-dingtalk-personal.apiName.completeTodos': 'Complete to-dos',
  'builtins.lobe-dingtalk-personal.description':
    'Read your own DingTalk to-dos, group messages and work reports with your authorization',
  'builtins.lobe-dingtalk-personal.render.auth.askAgain': 'Authorized. Ask again to continue.',
  'builtins.lobe-dingtalk-personal.render.collapse': 'Show less',
  'builtins.lobe-dingtalk-personal.render.confirm.actingAs': 'Runs as your own DingTalk account',
  'builtins.lobe-dingtalk-personal.render.confirm.approveBlocked':
    'The preview failed, so this approval was blocked.',
  'builtins.lobe-dingtalk-personal.render.confirm.approvePending':
    'The preview is still loading. Wait for the summary before approving.',
  'builtins.lobe-dingtalk-personal.render.confirm.blocked': 'Cannot preview this action',
  'builtins.lobe-dingtalk-personal.render.confirm.blockedHint':
    'The preview failed. Do not approve. To cancel, enter a rejection reason and choose “Submit”.',
  'builtins.lobe-dingtalk-personal.render.confirm.rawArgs': 'Show arguments',
  'builtins.lobe-dingtalk-personal.render.count': 'Total: {{count}}',
  'builtins.lobe-dingtalk-personal.render.domain.chat': 'DingTalk group chats',
  'builtins.lobe-dingtalk-personal.render.domain.report': 'DingTalk reports',
  'builtins.lobe-dingtalk-personal.render.domain.todo': 'My DingTalk to-dos',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_IDENTITY_INACTIVE':
    'DingTalk account is inactive',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_IDENTITY_UNBOUND':
    'DingTalk account is not linked. Sign in with DingTalk or message the DingTalk bot once.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_IDENTITY_UNVERIFIED':
    'DingTalk identity is not verified. Sign in with DingTalk or message the DingTalk bot once.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_BROKER_UNAVAILABLE':
    'The DingTalk personal data service is unavailable',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_CORP_ID_MISSING':
    'The DingTalk organization is not configured yet',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_DISABLED':
    'DingTalk personal data is turned off by the admin',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_EXPIRED':
    'Your DingTalk authorization has expired. Authorize again.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_FEATURE_DISABLED':
    'This capability is turned off by the admin',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_FILE_TOO_LARGE':
    'The file is too large (over 20 MB)',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_INTERNAL':
    'Something went wrong. Try again later.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_INVALID_ARGS':
    'Invalid parameters',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_LOGIN_NOT_FOUND':
    'The authorization request has expired',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_ORG_POLICY_DENIED':
    'The company DingTalk admin has not opened this capability to the CLI',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_OUTPUT_TOO_LARGE':
    'Too much data. Narrow the range and try again.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_PAT_REQUIRED':
    'DingTalk needs you to confirm an extra permission',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_RATE_LIMITED':
    'Too many requests. Try again later.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_REVOKE_FAILED':
    'Could not revoke the authorization. Please try again later.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_TIMEOUT':
    'DingTalk took too long to respond. Try again later.',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_UNAUTHORIZED':
    'DingTalk personal data is not authorized yet',
  'builtins.lobe-dingtalk-personal.render.error.DINGTALK_PERSONAL_UPSTREAM':
    'DingTalk returned an error',
  'builtins.lobe-dingtalk-personal.render.error.unknown': 'Operation failed',
  'builtins.lobe-dingtalk-personal.render.field.createdTime': 'Created',
  'builtins.lobe-dingtalk-personal.render.field.creator': 'Creator',
  'builtins.lobe-dingtalk-personal.render.field.due': 'Due',
  'builtins.lobe-dingtalk-personal.render.field.executors': 'Assignees',
  'builtins.lobe-dingtalk-personal.render.field.participants': 'Participants',
  'builtins.lobe-dingtalk-personal.render.field.priority': 'Priority',
  'builtins.lobe-dingtalk-personal.render.file.hidePreview': 'Hide content preview',
  'builtins.lobe-dingtalk-personal.render.file.noPreview': 'This file type cannot be read as text.',
  'builtins.lobe-dingtalk-personal.render.file.open': 'Open file',
  'builtins.lobe-dingtalk-personal.render.file.showPreview': 'Show content preview',
  'builtins.lobe-dingtalk-personal.render.group.empty': 'No groups found',
  'builtins.lobe-dingtalk-personal.render.group.members': '{{count}} members',
  'builtins.lobe-dingtalk-personal.render.hasMore':
    'There are more results. Ask the assistant to continue.',
  'builtins.lobe-dingtalk-personal.render.message.count': '{{count}} messages',
  'builtins.lobe-dingtalk-personal.render.message.empty': 'No messages in this period',
  'builtins.lobe-dingtalk-personal.render.message.more':
    'This period has more messages than were returned.',
  'builtins.lobe-dingtalk-personal.render.message.unknownSender': 'Unknown member',
  'builtins.lobe-dingtalk-personal.render.openInDingtalk': 'Open in DingTalk',
  'builtins.lobe-dingtalk-personal.render.page': 'Page {{page}}',
  'builtins.lobe-dingtalk-personal.render.priority.high': 'High',
  'builtins.lobe-dingtalk-personal.render.priority.low': 'Low',
  'builtins.lobe-dingtalk-personal.render.priority.normal': 'Normal',
  'builtins.lobe-dingtalk-personal.render.priority.urgent': 'Urgent',
  'builtins.lobe-dingtalk-personal.render.report.box.inbox': 'Reports I received',
  'builtins.lobe-dingtalk-personal.render.report.box.outbox': 'Reports I sent',
  'builtins.lobe-dingtalk-personal.render.report.empty': 'No reports found',
  'builtins.lobe-dingtalk-personal.render.report.noContent': 'This report has no content',
  'builtins.lobe-dingtalk-personal.render.showAll': 'Show all {{count}}',
  'builtins.lobe-dingtalk-personal.render.template.empty': 'No report templates available',
  'builtins.lobe-dingtalk-personal.render.template.fieldCount': '{{count}} fields',
  'builtins.lobe-dingtalk-personal.render.template.noFields': 'This template has no fields',
  'builtins.lobe-dingtalk-personal.render.todo.dueAt': 'Due {{time}}',
  'builtins.lobe-dingtalk-personal.render.todo.empty': 'No to-dos',
  'builtins.lobe-dingtalk-personal.render.todo.hasMore':
    'There are more to-dos. Ask the assistant for the next page.',
  'builtins.lobe-dingtalk-personal.render.todo.overdueAt': 'Overdue · {{time}}',
  'builtins.lobe-dingtalk-personal.render.todo.status.all': 'All',
  'builtins.lobe-dingtalk-personal.render.todo.status.done': 'Done',
  'builtins.lobe-dingtalk-personal.render.todo.status.open': 'Open',
  'builtins.lobe-dingtalk-personal.render.unnamed.file': 'Untitled file',
  'builtins.lobe-dingtalk-personal.render.unnamed.group': 'Unnamed group',
  'builtins.lobe-dingtalk-personal.render.unnamed.report': 'Untitled report',
  'builtins.lobe-dingtalk-personal.render.unnamed.template': 'Untitled template',
  'builtins.lobe-dingtalk-personal.render.unnamed.todo': 'Untitled to-do',
  'builtins.lobe-dingtalk-personal.render.written.completeTodo': 'To-do completed',
  'builtins.lobe-dingtalk-personal.render.written.submitReport': 'Report submitted',
  'builtins.lobe-dingtalk-personal.render.written.updateTodo': 'To-do updated',
  'builtins.lobe-dingtalk-personal.render.batch.action.completeTodos': 'Complete {{count}} to-dos',
  'builtins.lobe-dingtalk-personal.render.batch.result':
    '{{succeeded}} succeeded, {{failed}} failed',
  'builtins.lobe-dingtalk-personal.title': 'DingTalk personal data',
  'builtins.lobe-dingtalk-workspace.apiName.completeTodo': 'Complete todo',
  'builtins.lobe-dingtalk-workspace.apiName.createEvent': 'Create event',
  'builtins.lobe-dingtalk-workspace.apiName.createTodo': 'Create todo',
  'builtins.lobe-dingtalk-workspace.apiName.deleteEvent': 'Delete event',
  'builtins.lobe-dingtalk-workspace.apiName.deleteTodo': 'Delete todo',
  'builtins.lobe-dingtalk-workspace.apiName.getEvent': 'Get event',
  'builtins.lobe-dingtalk-workspace.apiName.listEvents': 'List events',
  'builtins.lobe-dingtalk-workspace.apiName.listMeetingRooms': 'List meeting rooms',
  'builtins.lobe-dingtalk-workspace.apiName.listTodos': 'List todos',
  'builtins.lobe-dingtalk-workspace.apiName.queryFreeBusy': 'Query free/busy',
  'builtins.lobe-dingtalk-workspace.apiName.respondEvent': 'Respond to event',
  'builtins.lobe-dingtalk-workspace.apiName.searchDirectory': 'Search directory',
  'builtins.lobe-dingtalk-workspace.apiName.updateEvent': 'Update event',
  'builtins.lobe-dingtalk-workspace.apiName.updateTodo': 'Update todo',
  'builtins.lobe-dingtalk-workspace.apiName.completeTodos': 'Complete todos',
  'builtins.lobe-dingtalk-workspace.apiName.deleteTodos': 'Delete todos',
  'builtins.lobe-dingtalk-workspace.description':
    'Create and manage DingTalk todos and calendar events',
  'builtins.lobe-dingtalk-workspace.title': 'DingTalk calendar & todos',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.completeTodo': 'Complete todo',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.createEvent': 'Create event',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.createTodo': 'Create todo',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.deleteEvent': 'Delete event',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.deleteTodo': 'Delete todo',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.getEvent': 'Get event',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.listEvents': 'List events',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.listMeetingRooms': 'List meeting rooms',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.listTodos': 'List todos',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.queryFreeBusy': 'Query free/busy',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.respondEvent': 'Respond to event',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.searchDirectory': 'Search directory',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.updateEvent': 'Update event',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.updateTodo': 'Update todo',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.completeTodos': 'Complete todos',
  'builtins.lobe-dingtalk-workspace.ui.apiLabel.deleteTodos': 'Delete todos',
  'builtins.lobe-dingtalk-workspace.ui.confirm.actingAs': 'Acting as {{name}}',
  'builtins.lobe-dingtalk-workspace.ui.confirm.actingAsUnknown':
    'Acting as your linked DingTalk identity',
  'builtins.lobe-dingtalk-workspace.ui.confirm.approveBlocked':
    'The preview failed, so this approval was blocked.',
  'builtins.lobe-dingtalk-workspace.ui.confirm.approvePending':
    'The preview is still loading. Wait for the summary before approving.',
  'builtins.lobe-dingtalk-workspace.ui.confirm.blocked': 'Cannot preview this action',
  'builtins.lobe-dingtalk-workspace.ui.confirm.blockedHint':
    'The preview failed. Do not approve. To cancel, enter a rejection reason and choose “Submit”.',
  'builtins.lobe-dingtalk-workspace.ui.confirm.rawArgs': 'Show arguments',
  'builtins.lobe-dingtalk-workspace.ui.confirm.showAll': 'Show all {{count}}',
  'builtins.lobe-dingtalk-workspace.ui.domain.calendar': 'DingTalk Calendar',
  'builtins.lobe-dingtalk-workspace.ui.domain.directory': 'DingTalk Directory',
  'builtins.lobe-dingtalk-workspace.ui.domain.todo': 'DingTalk To-dos',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_AMBIGUOUS': 'Several people match this name',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_AUTOMATION_OFF': 'Auto-approval is off',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_FEATURE_DISABLED':
    'This capability is turned off',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_FORBIDDEN': 'No permission for this action',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_IDENTITY_INACTIVE':
    'DingTalk account is inactive',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_IDENTITY_UNBOUND':
    'DingTalk account is not linked',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_IDENTITY_UNVERIFIED':
    'DingTalk identity is not verified',
  ...
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_NOT_TASK_OWNER':
    'Not the current task handler',
  'builtins.lobe-dingtalk-workspace.ui.error.DINGTALK_PREMIUM_REQUIRED':
  ...
  'builtins.lobe-dingtalk-workspace.ui.error.unknown': 'Operation failed',
  'builtins.lobe-dingtalk-workspace.ui.render.allDay': 'All day',
  'builtins.lobe-dingtalk-workspace.ui.render.ambiguous': 'Several matches',
  'builtins.lobe-dingtalk-workspace.ui.render.attendeeCount': 'Attendees: {{count}}',
  'builtins.lobe-dingtalk-workspace.ui.render.busyBlocks': 'Busy: {{count}}',
  'builtins.lobe-dingtalk-workspace.ui.render.capacity': 'Seats: {{count}}',
  'builtins.lobe-dingtalk-workspace.ui.render.count': 'Total: {{count}}',
  'builtins.lobe-dingtalk-workspace.ui.render.empty': 'No results',
  'builtins.lobe-dingtalk-workspace.ui.render.field.attendees': 'Attendees',
  'builtins.lobe-dingtalk-workspace.ui.render.field.description': 'Notes',
  'builtins.lobe-dingtalk-workspace.ui.render.field.location': 'Location',
  'builtins.lobe-dingtalk-workspace.ui.render.field.time': 'Time',
  'builtins.lobe-dingtalk-workspace.ui.render.free': 'Free',
  'builtins.lobe-dingtalk-workspace.ui.render.more': '+{{count}}',
  'builtins.lobe-dingtalk-workspace.ui.render.priority.high': 'High',
  'builtins.lobe-dingtalk-workspace.ui.render.priority.low': 'Low',
  'builtins.lobe-dingtalk-workspace.ui.render.priority.normal': 'Normal',
  ...
  'builtins.lobe-dingtalk-workspace.ui.render.todo.appTodos': 'Created by this assistant',
  'builtins.lobe-dingtalk-workspace.ui.render.todo.approvals': 'Awaiting my approval ({{count}})',
  'builtins.lobe-dingtalk-workspace.ui.render.todo.empty': 'No to-dos',
  'builtins.lobe-dingtalk-workspace.ui.render.todo.orgTodos': 'Organization to-dos',
  'builtins.lobe-dingtalk-workspace.ui.render.todo.overdue': 'Overdue',
  'builtins.lobe-dingtalk-workspace.ui.render.todo.personalTodos': 'My DingTalk to-dos',
  ...
  'builtins.lobe-dingtalk-workspace.ui.written.deleteEvent': 'Event deleted',
  'builtins.lobe-dingtalk-workspace.ui.written.deleteTodo': 'To-do deleted',
  'builtins.lobe-dingtalk-workspace.ui.written.respondEvent': 'Invitation answered',
  'builtins.lobe-dingtalk-workspace.ui.written.updateEvent': 'Event updated',
  'builtins.lobe-dingtalk-workspace.ui.written.updateTodo': 'To-do updated',
  'builtins.lobe-dingtalk-workspace.ui.batch.action.completeTodos': 'Complete {{count}} todos',
  'builtins.lobe-dingtalk-workspace.ui.batch.action.deleteTodos': 'Delete {{count}} todos',
  'builtins.lobe-dingtalk-workspace.ui.batch.result': '{{succeeded}} succeeded, {{failed}} failed',
  ...
  'builtins.lobe-dingtalk-approval.apiName.addApprover': 'Add approver',
  'builtins.lobe-dingtalk-approval.apiName.approveTask': 'Approve',
  'builtins.lobe-dingtalk-approval.apiName.commentApproval': 'Comment',
  'builtins.lobe-dingtalk-approval.apiName.createApprovalRule': 'Create approval rule',
  'builtins.lobe-dingtalk-approval.apiName.deleteApprovalRule': 'Delete approval rule',
  'builtins.lobe-dingtalk-approval.apiName.deleteTemplate': 'Delete template',
  'builtins.lobe-dingtalk-approval.apiName.getApprovalDetail': 'Approval detail',
  'builtins.lobe-dingtalk-approval.apiName.getTemplateSchema': 'Template schema',
  'builtins.lobe-dingtalk-approval.apiName.listApprovalRules': 'Approval rules',
  'builtins.lobe-dingtalk-approval.apiName.listMyApplications': 'My applications',
  'builtins.lobe-dingtalk-approval.apiName.listPendingApprovals': 'Pending approvals',
  'builtins.lobe-dingtalk-approval.apiName.listTemplates': 'Approval templates',
  'builtins.lobe-dingtalk-approval.apiName.refuseTask': 'Refuse',
  'builtins.lobe-dingtalk-approval.apiName.returnTask': 'Return task',
  'builtins.lobe-dingtalk-approval.apiName.saveTemplate': 'Save template',
  'builtins.lobe-dingtalk-approval.apiName.searchDirectory': 'Search directory',
  'builtins.lobe-dingtalk-approval.apiName.submitApproval': 'Submit approval',
  'builtins.lobe-dingtalk-approval.apiName.transferTask': 'Transfer',
  'builtins.lobe-dingtalk-approval.apiName.updateApprovalRule': 'Update approval rule',
  'builtins.lobe-dingtalk-approval.apiName.withdrawApplication': 'Withdraw',
  'builtins.lobe-dingtalk-approval.apiName.approveTasks': 'Batch approve',
  'builtins.lobe-dingtalk-approval.apiName.refuseTasks': 'Batch refuse',
  'builtins.lobe-dingtalk-approval.description':
    'View and handle DingTalk approvals, and manage automation rules',
  'builtins.lobe-dingtalk-approval.title': 'DingTalk Approval',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.addApprover': 'Add approver',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.approveTask': 'Approve',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.commentApproval': 'Comment',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.createApprovalRule': 'New rule',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.deleteApprovalRule': 'Delete rule',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.deleteTemplate': 'Delete template',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.getApprovalDetail': 'Approval detail',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.getTemplateSchema': 'Template fields',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.listApprovalRules': 'Automation rules',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.listMyApplications': 'My applications',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.listPendingApprovals': 'Pending approvals',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.listTemplates': 'Templates',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.refuseTask': 'Refuse',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.returnTask': 'Return',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.saveTemplate': 'Save template',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.searchDirectory': 'Directory',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.submitApproval': 'Submit',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.transferTask': 'Transfer',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.updateApprovalRule': 'Update rule',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.withdrawApplication': 'Withdraw',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.approveTasks': 'Batch approve',
  'builtins.lobe-dingtalk-approval.ui.apiLabel.refuseTasks': 'Batch refuse',
  'builtins.lobe-dingtalk-approval.ui.confirm.actingAs': 'Acting as {{name}} on DingTalk',
  'builtins.lobe-dingtalk-approval.ui.confirm.actingAsUnknown':
    'Acting as your linked DingTalk identity',
  'builtins.lobe-dingtalk-approval.ui.confirm.approveBlocked':
    'The preview failed, so this approval was blocked.',
  'builtins.lobe-dingtalk-approval.ui.confirm.approvePending':
    'The preview is still loading. Wait for the summary before approving.',
  'builtins.lobe-dingtalk-approval.ui.confirm.blocked': 'Cannot preview this action',
  'builtins.lobe-dingtalk-approval.ui.confirm.blockedHint':
    'The preview failed. Do not approve. To cancel, enter a rejection reason and choose “Submit”.',
  'builtins.lobe-dingtalk-approval.ui.confirm.rawArgs': 'Show arguments',
  'builtins.lobe-dingtalk-approval.ui.confirm.showAll': 'Show all {{count}}',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_AMBIGUOUS': 'Several people match this name',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_AUTOMATION_OFF': 'Auto-approval is off',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_FEATURE_DISABLED':
    'DingTalk approval is turned off',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_FORBIDDEN': 'No permission for this approval',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_IDENTITY_INACTIVE':
    'DingTalk account is inactive',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_IDENTITY_UNBOUND':
    'DingTalk account is not linked',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_IDENTITY_UNVERIFIED':
    'Sign in with DingTalk to run this action',
  ...
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_NOT_TASK_OWNER':
    'This approval is not yours to handle',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_PREMIUM_REQUIRED':
    'Requires DingTalk OA Premium',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_RATE_LIMITED':
    'Too many requests. Try again later.',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_RULE_LIMIT': 'Rule limit reached',
  'builtins.lobe-dingtalk-approval.ui.error.DINGTALK_UNAVAILABLE':
    'DingTalk is temporarily unavailable',
  'builtins.lobe-dingtalk-approval.ui.error.unknown': 'Operation failed',
  'builtins.lobe-dingtalk-approval.ui.render.count': 'Total: {{count}}',
  'builtins.lobe-dingtalk-approval.ui.render.countOnly': 'Total: {{count}} — details in the reply',
  'builtins.lobe-dingtalk-approval.ui.render.empty': 'No results',
  'builtins.lobe-dingtalk-approval.ui.render.more': '+{{count}}',
  'builtins.lobe-dingtalk-approval.ui.render.optional': 'Optional',
  'builtins.lobe-dingtalk-approval.ui.render.required': 'Required',
  'builtins.lobe-dingtalk-approval.ui.render.tag.disabled': 'Disabled',
  'builtins.lobe-dingtalk-approval.ui.render.tag.done': 'Done',
  ...
  'builtins.lobe-dingtalk-approval.ui.written.createApprovalRule': 'Rule created',
  'builtins.lobe-dingtalk-approval.ui.written.deleteApprovalRule': 'Rule deleted',
  'builtins.lobe-dingtalk-approval.ui.written.deleteTemplate': 'Template deleted',
  'builtins.lobe-dingtalk-approval.ui.written.refuseTask': 'Refused',
  'builtins.lobe-dingtalk-approval.ui.written.returnTask': 'Returned',
  'builtins.lobe-dingtalk-approval.ui.written.saveTemplate': 'Template saved',
  'builtins.lobe-dingtalk-approval.ui.written.submitApproval': 'Approval submitted',
  'builtins.lobe-dingtalk-approval.ui.written.transferTask': 'Transferred',
  'builtins.lobe-dingtalk-approval.ui.written.updateApprovalRule': 'Rule updated',
  'builtins.lobe-dingtalk-approval.ui.written.withdrawApplication': 'Withdrawn',
  'builtins.lobe-dingtalk-approval.ui.batch.action.approveTasks': 'Approve {{count}} requests',
  'builtins.lobe-dingtalk-approval.ui.batch.action.refuseTasks': 'Refuse {{count}} requests',
  'builtins.lobe-dingtalk-approval.ui.batch.result': '{{succeeded}} succeeded, {{failed}} failed',
  'builtins.lobe-reminder.apiName.cancelReminder': 'Cancel reminder',
  'builtins.lobe-reminder.apiName.createReminder': 'Create reminder',
  'builtins.lobe-reminder.apiName.listReminders': 'List reminders',
  'builtins.lobe-reminder.apiName.searchDirectory': 'Search directory',
  'builtins.lobe-reminder.inspector.ambiguous': 'Same name',
  'builtins.lobe-reminder.inspector.needsClarification': 'Needs clarification',
  'builtins.lobe-reminder.inspector.needsConfirmation': 'Needs confirmation',
  'builtins.lobe-reminder.render.cancel.done': 'Reminder canceled',
  'builtins.lobe-reminder.render.clarify.title': 'Please pick a recipient',
  'builtins.lobe-reminder.render.clarify.unknown': 'Unknown: {{name}}',
  'builtins.lobe-reminder.render.confirm.hint':
    'Please confirm in the conversation before creating it.',
  'builtins.lobe-reminder.render.confirm.title': 'Audience needs confirmation',
  'builtins.lobe-reminder.render.created.title': 'Reminder scheduled',
  'builtins.lobe-reminder.render.department': '{{name}} · {{count}} people',
  'builtins.lobe-reminder.render.field.content': 'Content',
  'builtins.lobe-reminder.render.field.identifier': 'Task',
  'builtins.lobe-reminder.render.field.nextFire': 'Next send',
  'builtins.lobe-reminder.render.field.recipients': 'Recipients',
  'builtins.lobe-reminder.render.field.schedule': 'Schedule',
  'builtins.lobe-reminder.render.list.empty': 'No reminders',
  'builtins.lobe-reminder.render.list.more': '+{{count}}',
  'builtins.lobe-reminder.render.list.title.created': 'Reminders I created',
  'builtins.lobe-reminder.render.list.title.received': 'Reminders I received',
  'builtins.lobe-reminder.render.search.ambiguous':
    'Several people share this name — confirm which one.',
  'builtins.lobe-reminder.render.search.departments': 'Departments',
  'builtins.lobe-reminder.render.search.empty': 'No matching people or departments',
  'builtins.lobe-reminder.render.search.title': 'Directory results',
  'builtins.lobe-reminder.render.search.users': 'People',
  'builtins.lobe-reminder.title': 'Reminders',
  ...
  'builtins.lobe-dingtalk-docs.title': 'DingTalk Docs & Sheets',
  'builtins.lobe-dingtalk-docs.apiName.searchDocs': 'Search docs',
  'builtins.lobe-dingtalk-docs.apiName.readDoc': 'Read doc',
  'builtins.lobe-dingtalk-docs.apiName.listWikiSpaces': 'List knowledge bases',
  'builtins.lobe-dingtalk-docs.apiName.listWikiNodes': 'Browse knowledge base',
  'builtins.lobe-dingtalk-docs.apiName.searchDrive': 'Search Drive',
  'builtins.lobe-dingtalk-docs.apiName.listDrive': 'Browse Drive',
  'builtins.lobe-dingtalk-docs.apiName.downloadDriveFile': 'Download Drive file',
  'builtins.lobe-dingtalk-docs.apiName.listSheets': 'List worksheets',
  'builtins.lobe-dingtalk-docs.apiName.readSheet': 'Read sheet',
  'builtins.lobe-dingtalk-docs.apiName.searchAitableBases': 'Find AI tables',
  'builtins.lobe-dingtalk-docs.apiName.listAitableTables': 'List AI table data tables',
  'builtins.lobe-dingtalk-docs.apiName.getAitableSchema': 'Get AI table fields',
  'builtins.lobe-dingtalk-docs.apiName.queryAitableRecords': 'Query AI table records',
  'builtins.lobe-dingtalk-docs.apiName.appendDoc': 'Append to doc',
  'builtins.lobe-dingtalk-docs.apiName.createDoc': 'Create doc',
  'builtins.lobe-dingtalk-docs.apiName.appendSheetRows': 'Append sheet rows',
  'builtins.lobe-dingtalk-docs.apiName.createAitableRecords': 'Add AI table records',
  'builtins.lobe-dingtalk-docs.apiName.updateAitableRecords': 'Update AI table records',
  'builtins.lobe-dingtalk-docs.inspector.searchDocs': 'Search docs: {{query}}',
  'builtins.lobe-dingtalk-docs.inspector.readDoc': 'Read doc “{{title}}”',
  'builtins.lobe-dingtalk-docs.inspector.listMyWikiSpaces': 'List my knowledge bases',
  'builtins.lobe-dingtalk-docs.inspector.listOrgWikiSpaces': 'List organization knowledge bases',
  'builtins.lobe-dingtalk-docs.inspector.nextPage': '{{action}} (next page)',
  'builtins.lobe-dingtalk-docs.inspector.searchDrive': 'Search Drive: {{query}}',
  'builtins.lobe-dingtalk-docs.inspector.downloadDriveFile': 'Download Drive file: {{name}}',
  'builtins.lobe-dingtalk-docs.inspector.readSheet': 'Read sheet {{range}}',
  'builtins.lobe-dingtalk-docs.inspector.searchAitableBases': 'Search AI tables: {{query}}',
  'builtins.lobe-dingtalk-docs.inspector.getAitableSchema': 'Get fields of “{{name}}”',
  'builtins.lobe-dingtalk-docs.inspector.queryAitableRecords': 'Query AI table records: {{query}}',
  'builtins.lobe-dingtalk-docs.inspector.createDoc': 'Create doc: {{title}}',
  'builtins.lobe-dingtalk-docs.inspector.appendSheetRows': 'Append {{count}} rows to sheet',
  'builtins.lobe-dingtalk-docs.inspector.createAitableRecords': 'Add {{count}} records to AI table',
  'builtins.lobe-dingtalk-docs.inspector.updateAitableRecords': 'Update {{count}} AI table records',
  'builtins.lobe-dingtalk-docs.render.untitled': 'Untitled',
  'builtins.lobe-dingtalk-docs.render.docs.empty': 'No documents found',
  'builtins.lobe-dingtalk-docs.render.doc.length': '{{count}} characters',
  'builtins.lobe-dingtalk-docs.render.doc.previewClipped':
    'Preview shows only the first {{count}} characters',
  'builtins.lobe-dingtalk-docs.render.doc.empty': 'This document is empty',
  'builtins.lobe-dingtalk-docs.render.wikiSpaces.empty': 'No knowledge bases found',
  'builtins.lobe-dingtalk-docs.render.wikiNodes.empty': 'This folder is empty',
  'builtins.lobe-dingtalk-docs.render.wikiNodes.hasChildren': 'Contains items',
  'builtins.lobe-dingtalk-docs.render.driveFiles.empty': 'No files found',
  'builtins.lobe-dingtalk-docs.render.kind.folder': 'Folder',
  'builtins.lobe-dingtalk-docs.render.kind.doc': 'Doc',
  'builtins.lobe-dingtalk-docs.render.kind.sheet': 'Sheet',
  'builtins.lobe-dingtalk-docs.render.kind.aitable': 'AI table',
  'builtins.lobe-dingtalk-docs.render.kind.online': 'Online doc',
  'builtins.lobe-dingtalk-docs.render.sheets.empty': 'No worksheets',
  'builtins.lobe-dingtalk-docs.render.sheets.usedRange': 'Data in {{range}}',
  'builtins.lobe-dingtalk-docs.render.sheetRange.empty': 'No data in this range',
  'builtins.lobe-dingtalk-docs.render.sheetRange.rows': '{{count}} rows',
  'builtins.lobe-dingtalk-docs.render.sheetRange.truncated':
    'Large sheet: only part of the range was read',
  'builtins.lobe-dingtalk-docs.render.table.showAll': 'Show all {{count}} rows',
  'builtins.lobe-dingtalk-docs.render.aitableBases.empty': 'No AI tables found',
  'builtins.lobe-dingtalk-docs.render.aitableTables.empty': 'This AI table has no data tables',
  'builtins.lobe-dingtalk-docs.render.aitableSchema.fieldCount': '{{count}} fields',
  'builtins.lobe-dingtalk-docs.render.aitableSchema.empty': 'This table has no fields',
  'builtins.lobe-dingtalk-docs.render.aitableRecords.empty': 'No records found',
  'builtins.lobe-dingtalk-docs.render.aitableRecords.total': '{{count}} records',
  'builtins.lobe-dingtalk-docs.render.aitableRecords.hasMore':
    'There are more records. Ask the assistant to continue.',
  'builtins.lobe-dingtalk-docs.render.fieldType.text': 'Text',
  'builtins.lobe-dingtalk-docs.render.fieldType.number': 'Number',
  'builtins.lobe-dingtalk-docs.render.fieldType.singleSelect': 'Single select',
  'builtins.lobe-dingtalk-docs.render.fieldType.multipleSelect': 'Multiple select',
  'builtins.lobe-dingtalk-docs.render.fieldType.date': 'Date',
  'builtins.lobe-dingtalk-docs.render.fieldType.checkbox': 'Checkbox',
  'builtins.lobe-dingtalk-docs.render.fieldType.user': 'Person',
  'builtins.lobe-dingtalk-docs.render.fieldType.url': 'URL',
  'builtins.lobe-dingtalk-docs.render.fieldType.attachment': 'Attachment',
  'builtins.lobe-dingtalk-docs.render.written.appendDoc': 'Appended to doc',
  'builtins.lobe-dingtalk-docs.render.written.createDoc': 'Doc created',
  'builtins.lobe-dingtalk-docs.render.written.appendSheetRows': 'Rows appended',
  'builtins.lobe-dingtalk-docs.render.written.createAitableRecords': 'Records added',
  'builtins.lobe-dingtalk-docs.render.written.updateAitableRecords': 'Records updated',
  'builtins.lobe-dingtalk-docs.description':
    'Search, read, and write your DingTalk docs, wikis, Drive, sheets, and AI tables',
  'confirm': 'Confirm',
