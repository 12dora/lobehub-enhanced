export default {
  ...
  'approvalRule.action.delete': 'Delete',
  'approvalRule.action.disable': 'Disable',
  'approvalRule.action.enable': 'Enable',
  'approvalRule.action.runs': 'Run history',
  'approvalRule.actionLabel.agree': 'Approve',
  'approvalRule.actionLabel.comment': 'Comment',
  'approvalRule.actionLabel.redirect': 'Transfer',
  'approvalRule.actionLabel.redirectTo': 'Transfer to {{name}}',
  'approvalRule.actionLabel.refuse': 'Reject',
  'approvalRule.column.action': 'Action',
  'approvalRule.column.actions': 'Actions',
  'approvalRule.column.condition': 'Conditions',
  'approvalRule.column.dailyUsage': 'Today',
  'approvalRule.column.expiry': 'Valid until',
  'approvalRule.column.name': 'Rule',
  'approvalRule.column.status': 'Status',
  'approvalRule.column.template': 'Approval template',
  'approvalRule.condition.any': 'All requests',
  'approvalRule.condition.clause': '{{label}} {{op}} {{value}}',
  'approvalRule.condition.clauseSeparator': '; ',
  'approvalRule.condition.listSeparator': ', ',
  'approvalRule.condition.op.contains': 'contains',
  'approvalRule.condition.op.in': 'is one of',
  'approvalRule.condition.originator': 'Initiator: {{targets}}',
  'approvalRule.condition.originatorSpecific': 'Initiator: selected people',
  'approvalRule.condition.otherField': 'Other conditions',
  'approvalRule.confirm.cancel': 'Cancel',
  'approvalRule.confirm.deleteContent':
    'Delete “{{name}}”? Matching approvals will no longer be handled automatically.',
  'approvalRule.confirm.deleteOk': 'Delete',
  'approvalRule.confirm.deleteTitle': 'Delete rule',
  'approvalRule.dailyUsage.limited': '{{used}} / {{cap}}',
  'approvalRule.dailyUsage.unlimited': '{{used}} · Unlimited',
  'approvalRule.desc':
    'These rules act in DingTalk with your identity. Ask the assistant in chat to add or change one.',
  'approvalRule.disabledReason.admin': 'Disabled by administrator',
  'approvalRule.disabledReason.expired': 'Expired',
  'approvalRule.disabledReason.identityInvalid': 'DingTalk identity unavailable',
  'approvalRule.disabledReason.tierOff': 'Automatic approval turned off',
  'approvalRule.disabledReason.user': 'Disabled by you',
  'approvalRule.empty.desc':
    'Tell the assistant what to automate in chat, for example “approve leave requests of one day or less from my team”.',
  ...
  'approvalRule.runs.column.originator': 'Initiator',
  'approvalRule.runs.column.result': 'Result',
  'approvalRule.runs.column.time': 'Time',
  'approvalRule.runs.empty': 'This rule has not run yet',
  'approvalRule.runs.status.failed': 'Failed',
  'approvalRule.runs.status.skippedQuota': 'Daily limit reached',
  'approvalRule.runs.status.succeeded': 'Succeeded',
  'approvalRule.runs.title': 'Run history',
  'approvalRule.status.disabled': 'Disabled',
  'approvalRule.status.enabled': 'Enabled',
  'approvalRule.toast.deleteFailed': 'Could not delete the rule. Try again.',
  'approvalRule.toast.deleted': 'Rule deleted',
  'approvalRule.toast.disabled': 'Rule disabled',
  'approvalRule.toast.enabled': 'Rule enabled',
  'approvalRule.toast.updateFailed': 'Could not update the rule. Try again.',
  'approvalRule.unavailable':
    'DingTalk approval is not enabled for this deployment, so automatic approval rules are unavailable.',
  ...
  'dingtalkPersonal.description':
    'Once you authorize, the assistant can read your own DingTalk to-dos, group messages and work reports as you, plus the docs, Drive, knowledge bases and sheets your admin has enabled. It only applies to your account and can be revoked at any time.',
  ...
  'dingtalkPersonal.features.docs': 'Docs / Drive / Knowledge bases',
  'dingtalkPersonal.features.report': 'Work reports',
  'dingtalkPersonal.features.sheets': 'Sheets / AI tables',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tab.approvalRules': 'Auto-approval rules',
